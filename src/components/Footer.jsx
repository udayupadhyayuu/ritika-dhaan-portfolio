  ...
  return (
    <footer className="bg-primary py-12 border-t border-muted border-opacity-20">
      <div className="container-custom">
        ...
        {/* Bottom Section */}
        {/* Bottom Section */}
        <div className="border-t border-muted border-opacity-10 pt-8 flex flex-col md:flex-row items-center justify-between text-sm text-muted">
          <motion.p
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-light inline-flex items-center border-b-2 border-transparent hover:border-white transition-colors duration-300"
