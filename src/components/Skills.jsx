...
const Skills = () => {
  ...
  const categories = [
    ...
    {
      name: "DevOps Automation & Scripting",
      skills: [
        ...
        "Automation for Infrastructure Tasks",
      ],
    },
    {
    ...
    {
      name: "Wireless & Enterprise Networking",
      skills: [
        "MikroTik RouterOS",
        "TP-Link Omada Controller",
        "OCNA – Omada Certified Network Administrator (Wireless)",
